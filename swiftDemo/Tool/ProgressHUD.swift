...
extension UIView: JGProgressHUDDelegate {
    ...
    func showLoading(_ text:String = "Loading", have_words:Bool = true, seconds:TimeInterval = 2.0, timeHidden:Bool = false, style:JGProgressHUDStyle = .dark) {
    ...
    func showSuccessHud(_ text:String = "Seccess!", have_words:Bool = true, seconds:TimeInterval = 2.0, timeHidden:Bool = false, style:JGProgressHUDStyle = .dark, hasImage:Bool = true, callback: (()->())? = nil) {
        ...
        if hasImage {
            ...
            if style == .dark {
                hud.indicatorView = JGProgressHUDIndicatorView(contentView: UIImageView(image: UIImage(named: "LHub_Hud_Success_White")))
            } else {
                hud.indicatorView = JGProgressHUDIndicatorView(contentView: UIImageView(image: UIImage(named: "LHub_Hud_Success_Black")))
            }
        } else {
...
extension UIViewController: JGProgressHUDDelegate {
    ...
    func showLoading(_ text:String = "Loading", have_words:Bool = true, seconds:TimeInterval = 2.0, timeHidden:Bool = false, style:JGProgressHUDStyle = .dark, bgColor : UIColor? = nil, textFont : UIFont? = nil) {
    ...
    func showSuccessHud(_ text:String = "Seccess!", have_words:Bool = true, seconds:TimeInterval = 2.0, timeHidden:Bool = false, style:JGProgressHUDStyle = .dark, hasImage:Bool = true, bgColor : UIColor? = nil, textFont : UIFont? = nil, callback: (()->())? = nil) {
        ...
        if hasImage {
            ...
            if style == .dark {
                hud.indicatorView = JGProgressHUDIndicatorView(contentView: UIImageView(image: UIImage(named: "Hud_Success_White")))
            } else {
                hud.indicatorView = JGProgressHUDIndicatorView(contentView: UIImageView(image: UIImage(named: "Hud_Success_Black")))
            }
        } else {
